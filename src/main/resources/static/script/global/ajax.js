const AjaxAPI = (() => {
    ...
    return {
        ...
        createSchedule: (schedule) => request({endpoint: "/schedules", data: schedule}),
        updateSchedule: (schedule, scheduleId) => request({endpoint: `/schedules/${scheduleId}`, method: "PATCH", data: schedule}),
