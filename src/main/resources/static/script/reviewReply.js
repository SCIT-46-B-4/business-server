...
function loadComments(reviewId) {
    ...
    $.ajax({
        url: `${staticPath}/api/schedules/reviews/${reviewId}/replies`,
        type: 'GET',
        dataType: 'json',
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btnSubmitReply', function() {
        ...
        $.ajax({
            url: `${staticPath}/api/schedules/reviews/${reviewId}/replies?parentReplyId=${parentId}`,
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify({
                content: content,
    ...
    $(document).on('click', '.btnUpdateReply', function() {
        ...
        $.ajax({
            url: `${staticPath}/api/schedules/reviews/${reviewId}/replies/${replyId}`,
            type: 'PUT',
            contentType: 'application/json',
